...
class UsuarioTest {
	...
	/*
	 * @BeforeClass public void inicializarDatos(@Qualifier("usuarioRepository")
	 * UsuarioRepository repositoryU) { u = new Usuario("Juan",
	 * "juan@gmail.com","1234"); ur = repositoryU; uc = new UsuarioController(ur);
...
//	}
	...
	@Test
	void insertUsuarioTest() throws Exception {
